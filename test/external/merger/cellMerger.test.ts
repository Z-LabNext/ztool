...
import { CellMerger } from '@/main';
import type {
  CellMergerOptions,
  DataSourceItem,
} from '@/external/merger/types/merger.types';
import {
  MERGE_OPTS_KEY,
  SORT_NO_KEY,
} from '@/external/merger/constants/merger.constants';
import data from '@/../examples/merger/data.json';
import { Mode, getFieldSpan, getMergedData, getSortNo } from '@/main';
